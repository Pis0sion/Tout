...
/**
 * \App\Kernel\Factory\MetaGeneratorFactory.
 */
class MetaGeneratorFactory
{
     ...
     * @return \Hyperf\Snowflake\MetaGenerator\RedisSecondMetaGenerator|mixed
     */
    public function __invoke(ContainerInterface $container)
    {
        ...
        return make(RedisSecondMetaGenerator::class, [
            $container->get(ConfigurationInterface::class), $beginSecond, $config,]);
    }
}
